...
import re
from typing import NamedTu
ple

import paho.mqtt.client as mqtt
from influxdb import InfluxDBClient

INFLUXDB_ADDRESS = 'ip' # palvelin jossa influxdb toimii
INFLUXDB_USER = 'useri'
INFLUXDB_PASSWORD = 'salari'
INFLUXDB_DATABASE = 'tietokannan nimi'

MQTT_ADDRESS = 'ip'  # palvelin jossa mqtt-brokeri toimii, esim. raspberry
MQTT_USER = 'useri'
